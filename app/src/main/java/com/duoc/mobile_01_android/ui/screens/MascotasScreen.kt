    ...
    Scaffold(
        ...
        AnimatedVisibility(
            ...
            Column(
                ...
                Text(
                    text = "Lista de Mascotas (${mascotas.size})",
                ...
                if (mascotas.isEmpty()) {
                    ...
                    LazyColumn(
                        ...
                        items(mascotas) { mascota ->
                            MascotaCard(
                                mascota = mascota,
                                cliente = clientes.find { it.id == mascota.clienteId },
                                onEdit = { loadMascotaToEdit(mascota) },
                ...
                text = {
                    Column {
                        ...
                        ExposedDropdownMenuBox(
                            ...
                            OutlinedTextField(
                                value = clientes.find { it.id == selectedClienteId }?.nombre ?: "",
                                onValueChange = {},
                                readOnly = true,
                                label = { Text("Dueno") },
